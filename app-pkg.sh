...
jpackage --type app-image --input ~/coding/grl/OSpkg/lib/mac-aarch64 --name Morning-arm --main-jar "$jar_name" --main-class org.william.tasks.App --java-options "--module-path ~/javafx/lib/ --add-modules javafx.controls,javafx.fxml"
jpackage --type app-image --input ~/coding/grl/OSpkg/lib/mac-intel --name Morning-x64 --main-jar "$jar_name" --main-class org.william.tasks.App --java-options "--module-path ~/javafx/lib/ --add-modules javafx.controls,javafx.fxml"
